...
func LinearGaussianMaximumLikelihoodEstimate(X Matrix, y Vector) Vector {
	...
	// the argmin of the squared error (because of the square difference
	// term in the guassian), which is given by the "normal equation".
	//
	...
	return SolveUpperTriangular(R, b)
}
